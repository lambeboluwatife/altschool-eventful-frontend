    ...
    <div className="features">
        ...
        <div className="grid grid-4">
            <div className="feature">
                ...
                <h6>Discover a wide range of events that cater to every taste and passion. From high-energy concerts featuring top artists to captivating theater performances that bring stories to life, there's something for everyone.</h6>
            </div>
            <div className="feature">
                <MdQrCode2 size={32} color="red"/>
                <h3>QR Code Tickets</h3>
                <h6>Experience seamless and secure entry to your favorite events with QR code tickets. When you purchase a ticket on Eventful, a unique QR code is generated, ensuring that your ticket is personal and secure.</h6>
            </div>
            <div className="feature">
                <FaRegStickyNote size={32} color="red"/>
                <h3>Reminders</h3>
                <h6>Never miss an event again with customizable reminders. Event creators can set reminders to notify attendees about event dates. This flexible reminder system ensures that both organizers and participants stay informed.</h6>
            </div>
            <div className="feature">
                <MdOutlineAnalytics size={32} color="red"/>
                <h3>Analytics</h3>
                <h6>Gain valuable insights into your event’s performance with detailed analytics. Eventful provides event creators with comprehensive data on attendee numbers, ticket sales, and engagement metrics.</h6>
            </div>
            {/* <div className="feature">
